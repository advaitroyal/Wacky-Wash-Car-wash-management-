...
{               ?>  
                    ...
                    <table>
                        <tr>
                            <td style="width:250px; height:250px; margin-top:0px;"><iframe src="https://www.google.com/maps?q=<?php echo htmlentities($result->latitude);?>,<?php echo htmlentities($result->longitude);?>&hl=es;z=14&output=embed" frameborder="0"></iframe></td>
                        </tr>
                    </table>
                                    </div>
                                </div>
